...
class Album(models.Model):
    ...
    # album_popularity = models.FloatField(default=None, blank=True, null=True)
    # album_genres = models.TextField(default=None, blank=True, null=True)
...
class Track(models.Model):
    ...
    # features_table_id = models.ForeignKey(AudioFeatures, on_delete=models.CASCADE, default=None, blank=True, null=True)
